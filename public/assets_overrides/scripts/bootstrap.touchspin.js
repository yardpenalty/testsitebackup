/* ek01 - this script was causing issues with the menu bar.  Without the change, if inquiry was taped on ipad
and then inquiry was tapped, the menu would disappear.*/
    ...
    $.fn.TouchSpin = function(options) {
        ...
        return this.each(function() {
            ...
            function _bindEvents()
            {
                ...
                //ek01$(document).on("mouseup touchend touchcancel", function(ev) {
                /*ek01*/$(".bootstrap-touchspin-up,.bootstrap-touchspin-down").on("mouseup touchend touchcancel", function(ev) {
                	if (!spinning) {
                        return;
                    }
                ...
                //ek01$(document).on("mousemove touchmove scroll scrollstart", function(ev) {
                /*ek01*/$(".bootstrap-touchspin-up,.bootstrap-touchspin-down").on("mousemove touchmove scroll scrollstart", function(ev) {
                    if (!spinning) {
                        return;
                    }
