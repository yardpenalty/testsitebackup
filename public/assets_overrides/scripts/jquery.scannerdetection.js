	...
	if(options === false){
		...
		if (!scanButtonCounter){
		    scanButtonCounter = 1;
								...
								//alert('lastCharTime-firstCharTime'+(lastCharTime-firstCharTime));
                //alert('stringWriting.length*options.avgTimeByChar'+(stringWriting.length*options.avgTimeByChar));
